        ...
        <>
            <div className="flex flex-col gap-12 xl:gap-[75px] mt-10 lg:mt-0">
                ...
                <div className="flex flex-col px-5 gap-5 lg:grid lg:grid-rows-4 lg:grid-cols-2 lg:mx-auto">
                    ...
                    <div className="bg-[#AC68FF] flex flex-col gap-4 items-center py-8 px-6 rounded-[20px] sm:max-w-[420px] sm:mx-auto xl:flex-row xl:max-w-[674px] xl:gap-7" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-easing="ease-in-sine" data-aos-duration="400">
